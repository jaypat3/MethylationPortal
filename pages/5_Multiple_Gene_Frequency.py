...
BLCA = './TCGADatasets/BLCA/GeneTableBLCAPValsMOD_10Perc.csv'
BRCA = './TCGADatasets/BRCA/GeneTableBRCAPValsMOD_10Perc.csv'
CESC = './TCGADatasets/CESC/GeneTableCESCPValsMOD_10Perc.csv'
COAD = './TCGADatasets/COAD/GeneTableCOADPValsMOD_10Perc.csv'
ESCA = './TCGADatasets/ESCA/GeneTableESCAPValsMOD_10Perc.csv'
GBM = './TCGADatasets/GBM/GeneTableGBMPValsMOD_10Perc.csv'
HNSC = './TCGADatasets/HNSC/GeneTableHNSCPValsMOD_10Perc.csv'
KIRC = './TCGADatasets/KIRC/GeneTableKIRCPValsMOD_10Perc.csv'
KIRP = './TCGADatasets/KIRP/GeneTableKIRPPValsMOD_10Perc.csv'
LGG = './TCGADatasets/LGG/GeneTableLGGPValsMOD_10Perc.csv'
LIHC = './TCGADatasets/LIHC/GeneTableLIHCPValsMOD_10Perc.csv'
LUAD = './TCGADatasets/LUAD/GeneTableLUADPValsMOD_10Perc.csv'
LUSC = './TCGADatasets/LUSC/GeneTableLUSCPValsMOD_10Perc.csv'
OV = './TCGADatasets/OV/GeneTableOVPValsMOD_10Perc.csv'
PAAD = './TCGADatasets/PAAD/GeneTablePAADPValsMOD_10Perc.csv'
PCPG = './TCGADatasets/PCPG/GeneTablePCPGPValsMOD_10Perc.csv'
PRAD = './TCGADatasets/PRAD/GeneTablePRADPValsMOD_10Perc.csv'
READ = './TCGADatasets/READ/GeneTableREADPValsMOD_10Perc.csv'
SARC = './TCGADatasets/SARC/GeneTableSARCPValsMOD_10Perc.csv'
SKCM = './TCGADatasets/SKCM/GeneTableSKCMPValsMOD_10Perc.csv'
STAD = './TCGADatasets/STAD/GeneTableSTADPValsMOD_10Perc.csv'
TGCT = './TCGADatasets/TGCT/GeneTableTGCTPValsMOD_10Perc.csv'
THCA = './TCGADatasets/THCA/GeneTableTHCAPValsMOD_10Perc.csv'
THYM = './TCGADatasets/THYM/GeneTableTHYMPValsMOD_10Perc.csv'
UCEC = './TCGADatasets/UCEC/GeneTableUCECPValsMOD_10Perc.csv'
